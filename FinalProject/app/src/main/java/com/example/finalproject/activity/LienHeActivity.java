...
public class LienHeActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(uit).title("Shop bán quần áo").snippet("khu phố 6, Thủ Đức, Ho Chi Minh City, Vietnam").icon(BitmapDescriptorFactory.defaultMarker()));
